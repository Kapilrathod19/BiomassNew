            ...
            <div class="bg-light rounded h-100 p-4">
                <form action="{{ route('admin.store.project') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="project_details" id="project_details" style="height: 150px;">{{ old('project_details') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="project_description" id="project_description" style="height: 150px;">{{ old('project_description') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="project_category" name="project_category" value="{{ old('project_category') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="project_client" name="project_client" value="{{ old('project_client') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="project_location" name="project_location" value="{{ old('project_location') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="project_value" name="project_value" value="{{ old('project_value') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="project_website" name="project_website" value="{{ old('project_website') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="project_line_1" name="project_line_1" value="{{ old('project_line_1') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="project_line_2" name="project_line_2" value="{{ old('project_line_2') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="project_line_3" name="project_line_3" value="{{ old('project_line_3') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="project_line_4" name="project_line_4" value="{{ old('project_line_4') }}">
