        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                <div class="bg-light rounded h-100 p-4">
                    <form action="{{ route('admin.update.certificate') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" id="id" name="id" value="{{ $certificate->id }}">
                        <div class="mb-3">
                            <img src="{{ asset('certificates/' . $certificate->image) }}" alt="Certificate" width="100px"
                                height="70px">
                        </div>
                        <div class="mb-3">
